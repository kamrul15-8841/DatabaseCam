package com.kamrul.databasecam;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dataList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				Intent intent = new Intent(SQLiteDemoActivity.this, DisplayImageActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case PICK_FROM_GALLERY:
			...
			if (extras2 != null) {
				...
				yourImage.compress(Bitmap.CompressFormat.PNG, 100, stream);
				byte imageInByte[] = stream.toByteArray();
				Log.e("output before convet", imageInByte.toString());
				// Inserting Contacts
				Log.d("Insert: ", "Inserting ..");
				db.addContact(new Contact("Android", imageInByte));
				Intent i = new Intent(SQLiteDemoActivity.this, SQLiteDemoActivity.class);
